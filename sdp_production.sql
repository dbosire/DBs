...
CREATE TABLE `bulk_balance` (
  ...
  `updated_by` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `bulk_balance`
--

INSERT INTO `bulk_balance` (`id`, `sms_balance`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 103, '', '2021-07-07 23:06:50', '2021-07-08 20:06:52');
...
(52, '2020_05_27_205026_create_bulk_balances_table', 1),
(53, '2020_08_21_141736_create_service_bookings_table', 3),
(54, '2021_07_08_010951_create_paybill_sms_table', 3),
(55, '2021_07_08_011019_create_mpesa_callback_records_table', 3);

-- --------------------------------------------------------

--
-- Table structure for table `mpesa_callback_records`
--

CREATE TABLE `mpesa_callback_records` (
  `id` int(10) UNSIGNED NOT NULL,
  `client_id` int(11) NOT NULL,
  `client_name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `paybill_no` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `phone_number` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `senderid` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `status` enum('Active','Inactive') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Inactive',
  `message` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `TransID` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Account_Number` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `TransTime` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `FullName` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `TransAmount` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `full_response` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `json_response` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `mpesa_callback_records`
--

INSERT INTO `mpesa_callback_records` (`id`, `client_id`, `client_name`, `paybill_no`, `phone_number`, `senderid`, `status`, `message`, `TransID`, `Account_Number`, `TransTime`, `FullName`, `TransAmount`, `full_response`, `json_response`, `created_at`, `updated_at`) VALUES
(1, 4, 'vigy', '123457', '254713374606', NULL, 'Active', NULL, 'PCJ1U93TUZ', '254712060823', '20210319085913', 'IRIS SHILWATSO ANGOTE', '150', 'POST /sms_mantiki/api/mpesa-callback HTTP/1.1\r\nAccept:          */*\r\nAccept-Encoding: gzip, deflate, br\r\nConnection:      keep-alive\r\nContent-Length:  473\r\nContent-Type:    application/json\r\nHost:            127.0.0.1\r\nPostman-Token:   6313804a-b571-43ad-979b-eb659dfd6f7a\r\nUser-Agent:      PostmanRuntime/7.26.8\r\n\r\n{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '2021-07-08 15:59:03', '2021-08-10 08:51:38'),
(2, 4, 'vigy', '123457', '254713374606', NULL, 'Active', NULL, 'PCJ1U93TUZ', '254712060823', '20210319085913', 'IRIS SHILWATSO ANGOTE', '150', 'POST /sms_mantiki/api/mpesa-callback HTTP/1.1\r\nAccept:          */*\r\nAccept-Encoding: gzip, deflate, br\r\nConnection:      keep-alive\r\nContent-Length:  473\r\nContent-Type:    application/json\r\nHost:            127.0.0.1\r\nPostman-Token:   51af7491-b168-4939-aa67-07bbfbe92a88\r\nUser-Agent:      PostmanRuntime/7.26.8\r\n\r\n{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '2021-07-08 16:04:12', '2021-08-10 08:51:38'),
(3, 4, 'vigy', '123457', '254713374606', NULL, 'Active', NULL, 'PCJ1U93TUZ', '254712060823', '20210319085913', 'IRIS SHILWATSO ANGOTE', '150', 'POST /sms_mantiki/api/mpesa-callback HTTP/1.1\r\nAccept:          */*\r\nAccept-Encoding: gzip, deflate, br\r\nConnection:      keep-alive\r\nContent-Length:  473\r\nContent-Type:    application/json\r\nHost:            127.0.0.1\r\nPostman-Token:   fee58560-49cf-4c2c-9213-425ae0817913\r\nUser-Agent:      PostmanRuntime/7.26.8\r\n\r\n{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '2021-07-08 16:08:09', '2021-08-10 08:51:38'),
(4, 4, 'vigy', '123457', '254713374606', 'DEN', 'Active', 'PCJ1U93TUZ Confirmed. IRIS, You have successfully registered to play on the Big Quiz Show this Sunday. Only on KTN Home from 8pm. T&Cs apply +254207903773', 'PCJ1U93TUZ', '254712060823', '20210319085913', 'IRIS SHILWATSO ANGOTE', '150', 'POST /sms_mantiki/api/mpesa-callback HTTP/1.1\r\nAccept:          */*\r\nAccept-Encoding: gzip, deflate, br\r\nConnection:      keep-alive\r\nContent-Length:  473\r\nContent-Type:    application/json\r\nHost:            127.0.0.1\r\nPostman-Token:   cc7c9723-f600-49ef-9c89-d66db261faf5\r\nUser-Agent:      PostmanRuntime/7.26.8\r\n\r\n{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '2021-07-08 16:12:25', '2021-08-10 08:51:38'),
(5, 4, 'vigy', '123457', '254713374606', 'DEN', 'Active', ' Dear . IRIS,Test SMS', 'PCJ1U93TUZ', '254712060823', '20210319085913', 'IRIS SHILWATSO ANGOTE', '150', 'POST /sms_mantiki/api/mpesa-callback HTTP/1.1\r\nAccept:          */*\r\nAccept-Encoding: gzip, deflate, br\r\nConnection:      keep-alive\r\nContent-Length:  473\r\nContent-Type:    application/json\r\nHost:            127.0.0.1\r\nPostman-Token:   cfe0668b-8fb4-4981-a142-a721b7436abf\r\nUser-Agent:      PostmanRuntime/7.26.8\r\n\r\n{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '2021-07-08 16:16:26', '2021-08-10 08:51:38'),
(6, 4, 'vigy', '123457', '254713374606', 'DEN', 'Active', 'Dear IRIS, Test SMS', 'PCJ1U93TUZ', '254712060823', '20210319085913', 'IRIS SHILWATSO ANGOTE', '150', 'POST /sms_mantiki/api/mpesa-callback HTTP/1.1\r\nAccept:          */*\r\nAccept-Encoding: gzip, deflate, br\r\nConnection:      keep-alive\r\nContent-Length:  473\r\nContent-Type:    application/json\r\nHost:            127.0.0.1\r\nPostman-Token:   1d3c8f3d-8975-4986-956f-d4e771c8d147\r\nUser-Agent:      PostmanRuntime/7.26.8\r\n\r\n{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '2021-07-08 16:17:18', '2021-08-10 08:51:38'),
(7, 4, 'vigy', '123457', '254713374606', 'DEN', 'Active', 'Dear IRIS, Test SMS', 'PCJ1U93TUZ', '254712060823', '20210319085913', 'IRIS SHILWATSO ANGOTE', '150', 'POST /sms_mantiki/api/mpesa-callback HTTP/1.1\r\nAccept:          */*\r\nAccept-Encoding: gzip, deflate, br\r\nConnection:      keep-alive\r\nContent-Length:  473\r\nContent-Type:    application/json\r\nHost:            127.0.0.1\r\nPostman-Token:   e9a6d92f-df5b-4ad3-93c6-3c4c1c21538e\r\nUser-Agent:      PostmanRuntime/7.26.8\r\n\r\n{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '2021-07-08 16:33:44', '2021-08-10 08:51:38'),
(8, 4, 'vigy', '123457', '254713374606', 'DEN', 'Active', 'Dear IRIS, Test SMS', 'PCJ1U93TUZ', '254712060823', '20210319085913', 'IRIS SHILWATSO ANGOTE', '150', 'POST /sms_mantiki/api/mpesa-callback HTTP/1.1\r\nAccept:          */*\r\nAccept-Encoding: gzip, deflate, br\r\nConnection:      keep-alive\r\nContent-Length:  473\r\nContent-Type:    application/json\r\nHost:            127.0.0.1\r\nPostman-Token:   094dcd30-125d-4f7d-8845-b5a39d8954d8\r\nUser-Agent:      PostmanRuntime/7.26.8\r\n\r\n{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '2021-07-08 17:32:33', '2021-08-10 08:51:38'),
(9, 4, 'vigy', '123457', '254713374606', 'DEN', 'Active', 'Dear IRIS, Test SMS', 'PCJ1U93TUZ', '254712060823', '20210319085913', 'IRIS SHILWATSO ANGOTE', '150', 'POST /sms_mantiki/api/mpesa-callback HTTP/1.1\r\nAccept:          */*\r\nAccept-Encoding: gzip, deflate, br\r\nConnection:      keep-alive\r\nContent-Length:  473\r\nContent-Type:    application/json\r\nHost:            127.0.0.1\r\nPostman-Token:   1e9ad6b7-663a-436d-bf78-c6b5f275dcb0\r\nUser-Agent:      PostmanRuntime/7.26.8\r\n\r\n{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '2021-07-08 17:56:30', '2021-08-10 08:51:38'),
(10, 4, 'vigy', '123457', '254713374606', 'DEN', 'Active', 'Dear IRIS, Test SMS', 'PCJ1U93TUZ', '254712060823', '20210319085913', 'IRIS SHILWATSO ANGOTE', '150', 'POST /sms/api/mpesa-callback HTTP/1.1\r\nAccept:          */*\r\nAccept-Encoding: gzip, deflate, br\r\nConnection:      keep-alive\r\nContent-Length:  473\r\nContent-Type:    application/json\r\nHost:            127.0.0.1\r\nPostman-Token:   6b603e29-a9f0-49af-a8c8-fdea874f2d16\r\nUser-Agent:      PostmanRuntime/7.26.8\r\n\r\n{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '2021-07-08 19:20:55', '2021-08-10 08:51:38'),
(11, 4, 'vigy', '123457', '254713374606', 'DEN', 'Active', 'Dear IRIS, Test SMS', 'PCJ1U93TUZ', '254712060823', '20210319085913', 'IRIS SHILWATSO ANGOTE', '150', 'POST /sms/api/mpesa-callback HTTP/1.1\r\nAccept:          */*\r\nAccept-Encoding: gzip, deflate, br\r\nConnection:      keep-alive\r\nContent-Length:  473\r\nContent-Type:    application/json\r\nHost:            127.0.0.1\r\nPostman-Token:   fe42d289-3797-43b3-9b9a-c0930c12c328\r\nUser-Agent:      PostmanRuntime/7.26.8\r\n\r\n{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '2021-07-08 19:56:00', '2021-08-10 08:51:38'),
(12, 4, 'vigy', '123457', '254713374606', 'DEN', 'Active', 'Dear IRIS, Test SMS', 'PCJ1U93TUZ', '254712060823', '20210319085913', 'IRIS SHILWATSO ANGOTE', '150', 'POST /sms/api/mpesa-callback HTTP/1.1\r\nAccept:          */*\r\nAccept-Encoding: gzip, deflate, br\r\nConnection:      keep-alive\r\nContent-Length:  473\r\nContent-Type:    application/json\r\nHost:            127.0.0.1\r\nPostman-Token:   bc4cfd5f-9a9a-43af-9221-6645a5969d44\r\nUser-Agent:      PostmanRuntime/7.26.8\r\n\r\n{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '2021-07-08 20:03:54', '2021-08-10 08:51:38'),
(13, 4, 'vigy', '123457', '254713374606', 'DEN', 'Active', 'Dear IRIS, Test SMS', 'PCJ1U93TUZ', '254712060823', '20210319085913', 'IRIS SHILWATSO ANGOTE', '150', 'POST /sms/api/mpesa-callback HTTP/1.1\r\nAccept:          */*\r\nAccept-Encoding: gzip, deflate, br\r\nConnection:      keep-alive\r\nContent-Length:  473\r\nContent-Type:    application/json\r\nHost:            127.0.0.1\r\nPostman-Token:   203c8220-ebf1-4e25-98f3-376ada536247\r\nUser-Agent:      PostmanRuntime/7.26.8\r\n\r\n{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"IRIS\",\r\n   \"MiddleName\":\"SHILWATSO\",\r\n   \"LastName\":\"ANGOTE\",\r\n   \"BusinessShortCode\":\"123457\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '2021-07-08 20:06:59', '2021-08-10 08:51:38'),
(14, 4, 'vigy', '444444', '254713374606', 'DEN 2', 'Active', 'Dear Dennis, It is working!', 'PCJ1U93TUZ', '254712060823', '20210319085913', 'Dennis N Bosire', '150', 'POST /sms/api/mpesa-callback HTTP/1.1\r\nAccept:          */*\r\nAccept-Encoding: gzip, deflate, br\r\nConnection:      keep-alive\r\nContent-Length:  467\r\nContent-Type:    application/json\r\nHost:            127.0.0.1\r\nPostman-Token:   ee5e5450-d6a1-401e-bd8c-98cc4a81c4e6\r\nUser-Agent:      PostmanRuntime/7.26.8\r\n\r\n{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"Dennis\",\r\n   \"MiddleName\":\"N\",\r\n   \"LastName\":\"Bosire\",\r\n   \"BusinessShortCode\":\"444444\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"Dennis\",\r\n   \"MiddleName\":\"N\",\r\n   \"LastName\":\"Bosire\",\r\n   \"BusinessShortCode\":\"444444\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '2021-07-09 18:53:39', '2021-08-10 08:51:38'),
(15, 4, 'vigy', '444444', '254713374606', 'DEN 2', 'Active', 'Dear Dennis, It is working!', 'PCJ1U93TUZ', '254712060823', '20210319085913', 'Dennis N Bosire', '150', 'POST /sms/api/mpesa-callback HTTP/1.1\r\nAccept:          */*\r\nAccept-Encoding: gzip, deflate, br\r\nConnection:      keep-alive\r\nContent-Length:  467\r\nContent-Type:    application/json\r\nHost:            127.0.0.1\r\nPostman-Token:   7d121802-7b31-4054-949d-971fa9e14988\r\nUser-Agent:      PostmanRuntime/7.26.8\r\n\r\n{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"Dennis\",\r\n   \"MiddleName\":\"N\",\r\n   \"LastName\":\"Bosire\",\r\n   \"BusinessShortCode\":\"444444\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '{\r\n   \"TransID\":\"PCJ1U93TUZ\",\r\n   \"TransTime\":\"20210319085913\",\r\n   \"BillRefNumber\":\"254712060823\",\r\n   \"FirstName\":\"Dennis\",\r\n   \"MiddleName\":\"N\",\r\n   \"LastName\":\"Bosire\",\r\n   \"BusinessShortCode\":\"444444\",\r\n   \"uuid\":\"12038cf0-2278-4547-8aed-ea8cf1f3e57f\",\r\n   \"gatewayId\":\"123457\",\r\n   \"url\":\"http://104.131.111.145/api/push_response\",\r\n   \"TransAmount\":150.0,\r\n   \"MSISDN\":254713374606,\r\n   \"priority\":1,\r\n   \"date\":\"Mar 19, 2021 8:59:13 AM\",\r\n   \"failed\":false\r\n}', '2021-07-09 18:55:33', '2021-08-10 08:51:38');
...
--
-- Table structure for table `paybill_sms`
--

CREATE TABLE `paybill_sms` (
  `id` int(10) UNSIGNED NOT NULL,
  `client_id` int(11) NOT NULL,
  `client_name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `paybill_sms`
--

INSERT INTO `paybill_sms` (`id`, `client_id`, `client_name`, `paybill_no`, `senderid`, `status`, `message`, `created_at`, `updated_at`) VALUES
(1, 4, 'vigy', 333333, 'DEN', 'Active', 'Hello, good progress!', '2021-07-08 00:17:59', '2021-07-09 18:46:52'),
(2, 4, 'vigy', 222222, 'DEN 2', 'Active', 'Message was changed!', '2021-07-08 00:20:00', '2021-07-12 15:13:55'),
(3, 4, 'vigy', 1234576, 'DEN', 'Active', 'Hello there!', '2021-07-08 00:38:55', '2021-07-12 15:13:35'),
(4, 4, 'vigy', 337575, 'DEN', 'Active', 'Hello, thank you for your contributions!', '2021-07-08 19:32:44', '2021-07-08 19:32:44'),
(5, 4, 'vigy', 444444, 'DEN 2', 'Active', 'It is working fine!', '2021-07-09 18:51:06', '2021-07-09 21:44:00'),
(6, 4, 'vigy2', 666666, 'DEN', 'Active', 'Hello there! b', '2021-07-12 15:17:04', '2021-08-10 12:29:22'),
(7, 4, 'vigy3', 123456, 'DEN', 'Active', 'Hello 23', '2021-08-10 09:42:17', '2021-08-10 11:25:34');
...
(1, 'Dennis', 'Bosire', 'admin', '$2y$10$DoiLMCYMiAOi52gsz.Ew1OUu/yEQX4rfrueoZ5iimwMFQkFU1CKve', 'Active', 'denaggrey@gmail.com', 'avatar.jpg', 0, NULL, '3445845391194833', NULL, 'No', 0, 1, '5Pe1upwwbIVHw0f1hME5rIR4wEmfTYOHylyAUF0n1SWlRfmBV0gMgYwdIgN6', '2018-11-14 08:04:21', '2020-09-16 23:14:13'),
(3, 'Sys', 'Admin', 'sys_admin', '$2y$10$B1WThgQdLgmOG36VpJr4buZuxTDNcnXiNOuyanRzjcUVVSbLpwVFK', 'Active', 'info@sourcecode.co.ke', 'profile.jpg', 3, NULL, NULL, NULL, 'Yes', 0, 1, '2snKAVFSHcWLeCxYucRyv7nDVqnueYeCova44YjSdHHKSLmpFMeY9ZlzX7eY', '2020-05-22 13:47:32', '2020-08-31 06:31:19');
...
--
-- Dumping data for table `sys_admin_role_perm`
--

INSERT INTO `sys_admin_role_perm` (`id`, `role_id`, `perm_id`, `created_at`, `updated_at`) VALUES
(136, 3, 1, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(137, 3, 2, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(138, 3, 3, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(139, 3, 4, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(140, 3, 5, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(141, 3, 6, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(142, 3, 7, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(143, 3, 8, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(144, 3, 9, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(145, 3, 10, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(146, 3, 11, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(147, 3, 12, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(148, 3, 13, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(149, 3, 14, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(150, 3, 15, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(151, 3, 16, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(152, 3, 17, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(153, 3, 18, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(154, 3, 19, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(155, 3, 20, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(156, 3, 21, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(157, 3, 22, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(158, 3, 23, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(159, 3, 24, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(160, 3, 25, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(161, 3, 26, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(162, 3, 27, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(163, 3, 28, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(164, 3, 29, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(165, 3, 30, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(166, 3, 31, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(167, 3, 32, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(168, 3, 33, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(169, 3, 34, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(170, 3, 35, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(171, 3, 36, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(172, 3, 37, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(173, 3, 38, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(174, 3, 39, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(175, 3, 40, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(176, 3, 41, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(177, 3, 42, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(178, 3, 43, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(179, 3, 44, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(180, 3, 45, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(181, 3, 46, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(182, 3, 47, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(183, 3, 48, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(184, 3, 49, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(185, 3, 50, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(186, 3, 51, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(187, 3, 52, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(188, 3, 53, '2020-06-17 05:22:59', '2020-06-17 05:22:59'),
(237, 2, 1, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(238, 2, 2, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(239, 2, 3, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(240, 2, 4, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(241, 2, 6, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(242, 2, 8, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(243, 2, 10, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(244, 2, 11, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(245, 2, 12, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(246, 2, 13, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(247, 2, 14, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(248, 2, 15, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(249, 2, 16, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(250, 2, 23, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(251, 2, 47, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(252, 2, 49, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(253, 2, 52, '2020-09-08 08:28:27', '2020-09-08 08:28:27'),
(254, 2, 53, '2020-09-08 08:28:27', '2020-09-08 08:28:27');
...
CREATE TABLE `sys_campaign_subscription_list` (
  ...
  `send_batch` enum('Yes','No') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'No',
...
CREATE TABLE `sys_clients` (
  ...
  `remember_token` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `bulksms_access` enum('Yes','No') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'No',
  `shortcodesms_access` enum('Yes','No') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'No',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `sys_clients` (`id`, `groupid`, `parent`, `fname`, `lname`, `company`, `website`, `email`, `username`, `password`, `address1`, `address2`, `state`, `city`, `postcode`, `country`, `phone`, `image`, `datecreated`, `sms_limit`, `api_access`, `api_key`, `api_gateway`, `online`, `status`, `reseller`, `sms_gateway`, `lastlogin`, `pwresetkey`, `pwresetexpiry`, `emailnotify`, `menu_open`, `lan_id`, `remember_token`, `bulksms_access`, `shortcodesms_access`, `created_at`, `updated_at`) VALUES
(1, 0, 0, 'Dencom', 'Bosire', 'Dencom', NULL, 'DENAGGREY@GMAIL.COM', 'dencom', '$2y$10$GWu6RCnmP62Jkipuo34QluV7mFucqB8.sWOIlTArQ/y4ILuaipMd2', '14780-00100 NAIROBI', NULL, 'Kenya', 'NAIROBI', '00100', 'Kenya', '0716880932', 'profile.jpg', '2021-01-23', '36', 'Yes', 'ZGVuY29tOmRlbmNvbS5wYXNzd29yZA==', 137, 0, 'Active', 'Yes', '\"[\\\"137\\\"]\"', NULL, NULL, 2021012354, 'No', 1, 1, 'W1oHxSG0Y9qo0egHtgvedxanYMsPjwRwOIbnHGmw09pJLAjnavbBlNyLqGuj', 'Yes', 'Yes', '2021-01-23 06:46:22', '2021-01-23 10:29:03'),
(3, 0, 0, 'vigy2', 'vigy2', NULL, NULL, 'vnmwangi151@gmail', 'vigy2', '$2y$10$oB4AyqSjtv7Gx34Wp/KK4.YtNyXhciFlme0NonyccmBYYlsQfITdu', NULL, NULL, NULL, NULL, NULL, 'Kenya', '0716880932', 'profile.jpg', '2021-06-22', '10', 'Yes', 'dmlneTI6dmlneTI=', 137, 0, 'Active', 'No', '\"[\\\"137\\\"]\"', NULL, NULL, NULL, 'No', 1, 1, 'sOzTKvYdc9vEdhibe2ldEbt0jX59xTkpXLhgXpKi4mM87AebHfxLwUxHDbc7', 'Yes', 'No', '2021-06-22 16:05:14', '2021-06-22 16:05:24'),
(4, 0, 0, 'vigy3', 'vigy3', NULL, NULL, 'vigy@gmail.com', 'vigy3', '$2y$10$701tlUfd63w698A93BH/IeUgaU2VsiS7WIi4ApLhnWpwtpqQNlKpS', NULL, NULL, NULL, NULL, NULL, 'Kenya', '0716880932', 'profile.jpg', '2021-06-22', '10', 'Yes', 'dmlneTM6dmlneTM=', 137, 0, 'Active', 'No', '\"[\\\"137\\\"]\"', NULL, NULL, NULL, 'No', 1, 1, 'WqDgKHPKbIguKFUEiHEUM5ZnzPq6reA2ohr3Lx8lXrssWR0hhnyf0edd8Ao9', 'Yes', 'No', '2021-06-22 16:19:53', '2021-08-09 13:25:20'),
(20, 0, 0, 'vigy', 'vigy', NULL, NULL, 'vnmwangi15@gmail.com', 'vigy', '$2y$10$WBhuDbTCTLf0elEO7gUL0OkkGfIOhFnp00SeB/DAXFraXrzogqQgm', NULL, NULL, NULL, NULL, NULL, 'Kenya', '0716880932', 'dennis passport.png', '2021-06-22', '4', 'Yes', 'dmlneTp2aWd5', 137, 0, 'Active', 'No', '\"[\\\"137\\\"]\"', NULL, NULL, NULL, 'No', 1, 1, 'k64TsUNRg5wRYpZIAhaEV4NyPFnDvaUBzVjiGsIIIEjdKcspxmwBnU7dL3kz', 'Yes', 'No', '2021-06-22 15:59:03', '2022-03-06 19:54:20');
...
(3, 137, 'usernameApi', 'sourceCode_apiuser', 'passwordApi', 'Kenya$321', 'yes', 'ServiceType', 'bulk_sendsms', 'yes', 'SenderID', 'SourceCode', 'yes', 'to', 'to', NULL, NULL, 'no', NULL, 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJNa29ub25pX2FwaXVzZXIiLCJhdWQiOiJBQ0NFU1MiLCJzY29wZXMiOiJBRE1JTiIsImlzcyI6Imh0dHA6Ly9zaXhkZWUuY29tIiwiaWF0IjoxNjA1NjMxMzc0LCJleHAiOjE2MDU2NDAzNzR9.J9pUDCI0x3WBF2Ikw4fdA70xmQoJ9XzNorQQcQs-3dmG1RM60-XAbHbfqBkZq_E6gvN9Q-RF__4PoQisgsck4A', 'no', '1', NULL, 'no', 'PackageID', '5227', 'yes', 'DeliveryReportURL', 'http://54.69.38.253/sms/sms/delivery-report-bulk-sms', 'yes', 'Portal_Username', 'SourceCode', 'yes', '2020-01-24 17:57:49', '2020-11-17 16:34:13'),
...
(5, 139, 'usernameApi', 'sourceCode_apiuser', 'passwordApi', 'Kenya$321', 'yes', 'ServiceType', 'subscription_sendsms', 'yes', 'CPID', '190', 'yes', 'to', 'test', NULL, NULL, 'no', NULL, 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJzb3VyY2VDb2RlX2FwaXVzZXIiLCJhdWQiOiJBQ0NFU1MiLCJzY29wZXMiOiJBRE1JTiIsImlzcyI6Imh0dHA6Ly9zaXhkZWUuY29tIiwiaWF0IjoxNjAyNTQwNzg3LCJleHAiOjE2MDI1NDQzODd9.Bi9k1DFfELT_t953CgGl7oFIcAOQPNtw1axh22DQ6K1ObCpheW83BNRlcwy2cG4z6XCPym45mnHUNtIi84V61Q', 'no', NULL, NULL, 'no', NULL, NULL, 'no', NULL, NULL, 'no', NULL, NULL, 'no', '2020-05-09 16:48:37', '2020-10-12 22:13:08');
...
(4, 1, 'Dencom Bosire', 1, '2021-01-23', '2021-01-23', '2021-01-23', '1', '1', 'Paid', 'Stripe', '0', 'yes', '', '2021-01-23 10:22:40', '2021-01-23 10:22:40'),
(5, 1, 'Dencom Bosire', 1, '2021-01-23', '2021-01-23', '2021-01-23', '1', '1', 'Paid', 'Stripe', '0', 'yes', '', '2021-01-23 10:29:03', '2021-01-23 10:29:03'),
(6, 2, 'vigy vigy', 1, '2021-07-07', '2021-07-07', '2021-07-07', '60000', '60000', 'Unpaid', '', '0', 'yes', NULL, '2021-07-07 19:23:19', '2021-07-07 19:23:19');
...
(4, 4, 1, 'Purchase SMS Unit', '1', 1, '1', '0', '0', '1', '2021-01-23 10:22:40', '2021-01-23 10:22:40'),
(5, 5, 1, 'Purchase SMS Unit', '1', 1, '1', '0', '0', '1', '2021-01-23 10:29:03', '2021-01-23 10:29:03'),
(6, 6, 2, 'MITL/TELCOINTEGRATION202101001', '60000', 1, '60000', '0', '0', '60000', '2021-07-07 19:23:19', '2021-07-07 19:23:19');
...
(1, 'DEN', '\"[\\\"0\\\"]\"', 'unblock', '2021-06-22 16:02:43', '2021-06-22 16:02:43'),
(2, 'DEN 2', '\"[\\\"2\\\"]\"', 'unblock', '2021-07-09 17:46:33', '2021-07-09 17:46:33');
...
(136, 'SAFTEST', 'SAFTEST', 'https://41.90.0.132:6502/SendSmsService/services/SendSms/', NULL, 'Yes', 'Yes', 'http', 'Inactive', 'Yes', 'No', 'No', '2019-05-03 20:01:40', '2020-05-10 21:39:10'),
...
(138, 'SAFARICOM_TEST', 'SAFARICOM_TEST', 'https://dtsvc.safaricom.com:8480/api/public/CMS/bulksms', NULL, 'Yes', 'Yes', 'http', 'Inactive', 'No', 'No', 'No', '2020-03-23 15:42:56', '2020-05-10 21:38:54'),
...
CREATE TABLE `sys_sms_history` (
  ...
  `receiver` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `message` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `amount` varchar(30) COLLATE utf8_unicode_ci NOT NULL DEFAULT '1',
  `use_gateway` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `api_key` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `status` text COLLATE utf8_unicode_ci NOT NULL,
  `sms_type` enum('plain','unicode','voice','mms','arabic') COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `sys_sms_history`
--

INSERT INTO `sys_sms_history` (`id`, `userid`, `sender`, `receiver`, `message`, `amount`, `use_gateway`, `api_key`, `status`, `sms_type`, `send_by`, `media_url`, `created_at`, `updated_at`) VALUES
(1, 2, 'DEN', '254713374606', 'Test SMS', '1', '137', '', 'Client error: `POST https://dsvc.safaricom.com:9480/api/public/CMS/bulksms` resulted in a `401 Unauthorized` response:\n{&quot;status&quot;:401,&quot;message&quot;:&quot;Token has expired&quot;,&quot;errorCode&quot;:11,&quot;timestamp&quot;:&quot;2021-07-08T16:08:11.805+0000&quot;}\n', 'plain', 'sender', NULL, '2021-07-08 16:08:09', '2021-07-08 16:08:09'),
(2, 2, 'DEN', '254713374606', 'Test SMS', '1', '137', '', 'Client error: `POST https://dsvc.safaricom.com:9480/api/public/CMS/bulksms` resulted in a `401 Unauthorized` response:\n{&quot;status&quot;:401,&quot;message&quot;:&quot;Token has expired&quot;,&quot;errorCode&quot;:11,&quot;timestamp&quot;:&quot;2021-07-08T16:12:28.056+0000&quot;}\n', 'plain', 'sender', NULL, '2021-07-08 16:12:25', '2021-07-08 16:12:25'),
(3, 2, 'DEN', '254713374606', ' Dear . IRIS,Test SMS', '1', '137', '', 'Client error: `POST https://dsvc.safaricom.com:9480/api/public/CMS/bulksms` resulted in a `401 Unauthorized` response:\n{&quot;status&quot;:401,&quot;message&quot;:&quot;Token has expired&quot;,&quot;errorCode&quot;:11,&quot;timestamp&quot;:&quot;2021-07-08T16:16:28.949+0000&quot;}\n', 'plain', 'sender', NULL, '2021-07-08 16:16:26', '2021-07-08 16:16:26'),
(4, 2, 'DEN', '254713374606', 'Dear IRIS, Test SMS', '1', '137', '', 'Client error: `POST https://dsvc.safaricom.com:9480/api/public/CMS/bulksms` resulted in a `401 Unauthorized` response:\n{&quot;status&quot;:401,&quot;message&quot;:&quot;Token has expired&quot;,&quot;errorCode&quot;:11,&quot;timestamp&quot;:&quot;2021-07-08T16:17:19.983+0000&quot;}\n', 'plain', 'sender', NULL, '2021-07-08 16:17:18', '2021-07-08 16:17:18'),
(5, 2, 'DEN', '254713374606', 'Dear IRIS, Test SMS', '1', '137', '', 'Client error: `POST https://dsvc.safaricom.com:9480/api/public/CMS/bulksms` resulted in a `401 Unauthorized` response:\n{&quot;status&quot;:401,&quot;message&quot;:&quot;Token has expired&quot;,&quot;errorCode&quot;:11,&quot;timestamp&quot;:&quot;2021-07-08T16:33:47.080+0000&quot;}\n', 'plain', 'sender', NULL, '2021-07-08 16:33:44', '2021-07-08 16:33:44'),
(6, 2, 'DEN', '254713374606', 'Dear IRIS, Test SMS', '1', '137', '', 'Client error: `POST https://dsvc.safaricom.com:9480/api/public/CMS/bulksms` resulted in a `401 Unauthorized` response:\n{&quot;status&quot;:401,&quot;message&quot;:&quot;Token has expired&quot;,&quot;errorCode&quot;:11,&quot;timestamp&quot;:&quot;2021-07-08T17:32:36.565+0000&quot;}\n', 'plain', 'sender', NULL, '2021-07-08 17:32:34', '2021-07-08 17:32:34'),
(7, 2, 'DEN', '254713374606', 'Dear IRIS, Test SMS', '1', '137', '', 'Client error: `POST https://dsvc.safaricom.com:9480/api/public/CMS/bulksms` resulted in a `401 Unauthorized` response:\n{&quot;status&quot;:401,&quot;message&quot;:&quot;Token has expired&quot;,&quot;errorCode&quot;:11,&quot;timestamp&quot;:&quot;2021-07-08T17:56:32.752+0000&quot;}\n', 'plain', 'sender', NULL, '2021-07-08 17:56:30', '2021-07-08 17:56:30'),
(8, 2, 'DEN', '254713374606', 'Dear IRIS, Test SMS', '1', '137', '', '403', 'plain', 'sender', NULL, '2021-07-08 19:20:55', '2021-07-08 19:20:55'),
(9, 2, 'DEN', '254713374606', 'Dear IRIS, Test SMS', '1', '137', '', '403', 'plain', 'sender', NULL, '2021-07-08 19:56:00', '2021-07-08 19:56:00'),
(10, 2, 'DEN 2', '254713374606', 'Dear Dennis, It is working!', '1', '137', '', '403', 'plain', 'sender', NULL, '2021-07-09 18:53:39', '2021-07-09 18:53:39'),
(11, 2, 'DEN 2', '254713374606', 'Dear Dennis, It is working!', '1', '137', '', '403', 'plain', 'sender', NULL, '2021-07-09 18:55:34', '2021-07-09 18:55:34'),
(12, 20, 'SourceCode', '254716880932', 'Order confirmation Order no:13 Items:{\"mahamris x 1\",\"Chapatis x 1\"} Receipt no:QBQ5QW4DCN Total:Ksh. 500.00', '1', '137', '', '403', 'plain', 'sender', NULL, '2022-03-06 19:54:19', '2022-03-06 19:54:19');
...
--
-- Dumping data for table `sys_sms_inbox`
--

INSERT INTO `sys_sms_inbox` (`id`, `msg_id`, `amount`, `message`, `status`, `send_by`, `mark_read`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'Test SMS', 'Client error: `POST https://dsvc.safaricom.com:9480/api/public/CMS/bulksms` resulted in a `401 Unauthorized` response:\n{&quot;status&quot;:401,&quot;message&quot;:&quot;Token has expired&quot;,&quot;errorCode&quot;:11,&quot;timestamp&quot;:&quot;2021-07-08T16:08:11.805+0000&quot;}\n', 'sender', 'no', '2021-07-08 16:08:09', '2021-07-08 16:08:09'),
(2, 2, 1, 'Test SMS', 'Client error: `POST https://dsvc.safaricom.com:9480/api/public/CMS/bulksms` resulted in a `401 Unauthorized` response:\n{&quot;status&quot;:401,&quot;message&quot;:&quot;Token has expired&quot;,&quot;errorCode&quot;:11,&quot;timestamp&quot;:&quot;2021-07-08T16:12:28.056+0000&quot;}\n', 'sender', 'no', '2021-07-08 16:12:25', '2021-07-08 16:12:25'),
(3, 3, 1, ' Dear . IRIS,Test SMS', 'Client error: `POST https://dsvc.safaricom.com:9480/api/public/CMS/bulksms` resulted in a `401 Unauthorized` response:\n{&quot;status&quot;:401,&quot;message&quot;:&quot;Token has expired&quot;,&quot;errorCode&quot;:11,&quot;timestamp&quot;:&quot;2021-07-08T16:16:28.949+0000&quot;}\n', 'sender', 'no', '2021-07-08 16:16:26', '2021-07-08 16:16:26'),
(4, 4, 1, 'Dear IRIS, Test SMS', 'Client error: `POST https://dsvc.safaricom.com:9480/api/public/CMS/bulksms` resulted in a `401 Unauthorized` response:\n{&quot;status&quot;:401,&quot;message&quot;:&quot;Token has expired&quot;,&quot;errorCode&quot;:11,&quot;timestamp&quot;:&quot;2021-07-08T16:17:19.983+0000&quot;}\n', 'sender', 'no', '2021-07-08 16:17:18', '2021-07-08 16:17:18'),
(5, 5, 1, 'Dear IRIS, Test SMS', 'Client error: `POST https://dsvc.safaricom.com:9480/api/public/CMS/bulksms` resulted in a `401 Unauthorized` response:\n{&quot;status&quot;:401,&quot;message&quot;:&quot;Token has expired&quot;,&quot;errorCode&quot;:11,&quot;timestamp&quot;:&quot;2021-07-08T16:33:47.080+0000&quot;}\n', 'sender', 'no', '2021-07-08 16:33:44', '2021-07-08 16:33:44'),
(6, 6, 1, 'Dear IRIS, Test SMS', 'Client error: `POST https://dsvc.safaricom.com:9480/api/public/CMS/bulksms` resulted in a `401 Unauthorized` response:\n{&quot;status&quot;:401,&quot;message&quot;:&quot;Token has expired&quot;,&quot;errorCode&quot;:11,&quot;timestamp&quot;:&quot;2021-07-08T17:32:36.565+0000&quot;}\n', 'sender', 'no', '2021-07-08 17:32:34', '2021-07-08 17:32:34'),
(7, 7, 1, 'Dear IRIS, Test SMS', 'Client error: `POST https://dsvc.safaricom.com:9480/api/public/CMS/bulksms` resulted in a `401 Unauthorized` response:\n{&quot;status&quot;:401,&quot;message&quot;:&quot;Token has expired&quot;,&quot;errorCode&quot;:11,&quot;timestamp&quot;:&quot;2021-07-08T17:56:32.752+0000&quot;}\n', 'sender', 'no', '2021-07-08 17:56:30', '2021-07-08 17:56:30'),
(8, 8, 1, 'Dear IRIS, Test SMS', '403', 'sender', 'no', '2021-07-08 19:20:55', '2021-07-08 19:20:55'),
(9, 9, 1, 'Dear IRIS, Test SMS', '403', 'sender', 'no', '2021-07-08 19:56:00', '2021-07-08 19:56:00'),
(10, 10, 1, 'Dear Dennis, It is working!', '403', 'sender', 'no', '2021-07-09 18:53:39', '2021-07-09 18:53:39'),
(11, 11, 1, 'Dear Dennis, It is working!', '403', 'sender', 'no', '2021-07-09 18:55:34', '2021-07-09 18:55:34'),
(12, 12, 1, 'Order confirmation Order no:13 Items:{\"mahamris x 1\",\"Chapatis x 1\"} Receipt no:QBQ5QW4DCN Total:Ksh. 500.00', '403', 'sender', 'no', '2022-03-06 19:54:19', '2022-03-06 19:54:19');
...
(1, 1, '33', '2021-01-23 06:46:22', '2021-01-23 06:46:22'),
(2, 1, '100', '2021-06-22 16:18:47', '2021-06-22 16:18:47'),
(3, 2, '-18', '2021-07-08 20:03:28', '2021-07-08 20:03:28'),
(4, 2, '5', '2021-07-08 20:06:52', '2021-07-08 20:06:52');
...
INSERT INTO `sys_tickets` (`id`, `did`, `cl_id`, `admin_id`, `name`, `email`, `date`, `subject`, `message`, `status`, `admin`, `replyby`, `closed_by`, `created_at`, `updated_at`) VALUES
(4, 3, 2, 0, 'vigy vigy', 'vnmwangi15@gmail.com', '2021-07-07', 'Test', 'Test', 'Pending', '0', '', '', '2021-07-07 19:20:18', '2021-07-07 19:20:18');
...
--
-- Indexes for table `mpesa_callback_records`
--
ALTER TABLE `mpesa_callback_records`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `paybill_sms`
--
ALTER TABLE `paybill_sms`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `mpesa_callback_records`
--
ALTER TABLE `mpesa_callback_records`
...
--
-- AUTO_INCREMENT for table `paybill_sms`
--
ALTER TABLE `paybill_sms`
